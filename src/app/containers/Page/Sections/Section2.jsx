    ...
    return (
        <div className="flex lg:flex-row md:flex-col flex-col-reverse gap-4">
            ...
            <div className="flex-1 w-full p-4">
                ...
                <br />
                <br />
                ตลอดเวลาที่คบกันมาพี่มีความสุขมาก ๆที่เราได้ไปเที่ยวกันหลาย ๆที่
                มีความทรงจำมากมาย ได้ร่วมเหนื่อย และพร้อมเอ็นจอยไปด้วยกันตลอด
                และพี่สัญญาว่าจะพาหนูไปเทึ่ยว
